@section('title', 'Newsletter Management - ' . config('app.name'))
    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Manage newsletter subscribers</p>
            </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    ...
                    <form action="{{ route('admin.subscribers.store') }}" method="POST" class="flex items-end space-x-4">
                        @csrf
                        <div class="flex-1">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($subscribers as $index => $subscriber)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <div>
                                                <p>{{ $subscriber->created_at->format('M j, Y') }}</p>
                                                <p class="text-xs text-gray-400">{{ $subscriber->created_at->format('g:i A') }}</p>
                                            </div>
                                        </td>
                ...
                @else
                    ...
                    <div class="p-12 text-center">
                        ...
                        <h3 class="text-xl font-medium text-gray-900 mb-2">No subscribers found</h3>
                        <p class="text-gray-500 mb-6">There are currently no newsletter subscribers.</p>
                        <p class="text-gray-500 text-sm">Use the form above to add the first subscriber manually.</p>
                    </div>
                @endif
            </div>
            ...
            <div class="mt-6 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Newsletter Statistics</h3>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="bg-green-50 rounded-lg p-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm font-medium text-green-600">Total Subscribers</p>
                                    <p class="text-2xl font-semibold text-green-900">{{ $subscribers->total() }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-blue-50 rounded-lg p-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm font-medium text-blue-600">Today's Subscriptions</p>
                                    <p class="text-2xl font-semibold text-blue-900">
                                        {{ \App\Models\Subscriber::whereDate('created_at', today())->count() }}
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p class="text-2xl font-semibold text-purple-900">
                                        {{ \App\Models\Subscriber::where('created_at', '>=', now()->startOfWeek())->count() }}
                                    </p>
                                </div>
                            </div>
                        </div>
